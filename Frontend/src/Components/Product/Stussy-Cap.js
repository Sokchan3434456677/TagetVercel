...
function StussyCap() {  // Corrected function name
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_PRODUCT_API_BASE_URL}/api/products/TEES`);
...
export default StussyCap;  // Corrected export statement
